...
```pySypaking
```
https://github.com/marinakhan956/Sypa-cloning
cd Sypa-cloning
python Sypa.py
...
[![](https://img.shields.io/badge/Whatsapp-CHAT-red?logo=Whatsapp&logoColor=Brightgreen&labelColor=white)](https://wa.me/+923017787729)
